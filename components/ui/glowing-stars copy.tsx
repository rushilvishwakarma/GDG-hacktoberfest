...
export const GlowingStarsBackgroundCard = ({
  ...
  return (
    <div
      ...
      className={ny(
        "bg-[linear-gradient(110deg,#333_0.6%,#222)] p-4 w-full h-full rounded-xl border border-[#eaeaea] dark:border-neutral-600",
        className
      )}
    >
...
useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (!mouseEnter) { // Only set random stars when not hovering
